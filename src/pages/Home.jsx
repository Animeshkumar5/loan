...
export default function Home() {
  ...
  return (
    <div className="bg-gray-50 font-sans">
      ...
      {/* 1. HERO SECTION */}
      <div className="relative bg-white h-auto md:h-[900px] flex items-center overflow-hidden pb-20 pt-2 md:py-0">
        <div className="max-w-[1280px] w-full mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center h-full">
          ...
          {/* RIGHT IMAGE */}
          <div className="relative w-full h-full flex items-center justify-center mt-5 md:mt-0">
            <img
              src="/hero.png"
              alt="Loan Hero"
      ...
      <div className="container mx-auto px-6 relative z-20 -mt-20 mb-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          ...
          {[
            ...
            <div
              key={index}
              className="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100 transform hover:-translate-y-2 transition duration-300 cursor-pointer"
            >
