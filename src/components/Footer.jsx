...
export default function Footer() {
  return (
    // Added pb-20 or pb-24 if you want to ensure the footer isn't hidden by the sticky alert
    <footer className="bg-gray-900 text-white pt-16 pb-24 border-t border-gray-800">
      <div className="container mx-auto px-6">
        
        <div className="flex flex-col md:flex-row justify-between items-start gap-10">
          
          {/* 1. LOGO, BRAND & SOCIAL MEDIA */}
          ...
          <div className="md:w-1/3">
            ...
            <div className="space-y-6 text-sm text-gray-300">
              ...
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-blue-400 flex-shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+918795555728" className="hover:text-white transition">
                    +91 8795555728
                  </a>
                </div>
              </div>
